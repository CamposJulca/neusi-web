    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <a
            href="/intranet/"
            className="ml-1 flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/20 text-white/60 hover:text-white hover:border-white/40 text-xs font-semibold transition-all"
          >
        ...
        {open && (
          ...
          >
            <div className="px-4 py-3 flex flex-col gap-1">
              ...
              <a
                href="/intranet/"
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold text-white/60 hover:text-white hover:bg-white/8 transition-all border border-white/10 mt-1"
              >
